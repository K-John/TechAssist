var testDataGenerator = (function (LabelCtrl, DBCtrl, UICtrl) {
    ...
    var setupEventListeners = function () {
        document.getElementById("submitlabelcount").addEventListener('click', ctrlGenerate);
    };

    var ctrlGenerate = function () {
    ...
    var generate = function (count) {
        ...
        schoolId = randomInt(1, 39);
        firstName = firstNames[randomInt(1, firstNames.length)];
        lastName = lastNames[randomInt(1, lastNames.length)];
        ...
        customAlert(LabelCtrl.newLabel(schoolId.toString(), firstName, lastName, barcode.toString(), labelSpot.toString()), labelSpot.toString(), function () {
            ...
            document.getElementById("progresslabelcount").textContent = progress;
            if (x < count) {
                generate(count);
            } else {
                console.log("Made it");
    ...
    var customAlert = function (item, id, callback) {
    ...
    return {
        init: function (loopCount) {
            setupEventListeners();
            establishDB(function (result, err) {
                if (!result) {
